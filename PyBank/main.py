...
txtpath = os.path.join('Analysis', 'PyBank_Financial_Records_Analysis.txt')
#di = dict()
total_amount = 0
...
#Format average change value to two decimal places'  
average_change = total_changes/count
average_change = '{:.2f}'.format(average_change)

#Change date format from 2 digits to 4 digits for the year'    
